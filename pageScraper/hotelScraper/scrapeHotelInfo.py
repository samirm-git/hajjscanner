...
import copy
import re
from .hotelRegexConsts import CITY_PATTERNS
from .hotelFieldScraper import HotelFieldScraper
...
def scrapeHotelInfo(soup, city, url):
  ...
  hotelInfo = HotelFieldScraper.run(soup=mergedSoup, city=city, url=url)  
